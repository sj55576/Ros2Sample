...
approaches can be compared on the same scenario.
"""
...
def generate_launch_description():
    """Return a LaunchDescription for the behavior-tree mission demo scenario."""
    share_dir = get_package_share_directory('drone_sim')
    default_config = join(share_dir, 'config', 'mission_bt_demo.yaml')
    ...
    return LaunchDescription([
        ...
        Node(
            package='drone_sim',
            executable='mission_behavior_tree',
